                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="">
                                        <a href="<?php echo base_url('assets\extra-pages\landingpage\index.htm');?>" target="_blank" data-i18n="nav.landing-page.main"> <span class="pcoded-micon"><i class="ti-mobile"></i></span> <span class="pcoded-mtext">Landing Page</span> <span class="pcoded-mcaret"></span> </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="pcoded-hasmenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            ...
                                            <li class="pcoded-hasmenu ">
                                                ...
                                                <ul class="pcoded-submenu">
                                                    <li class="">
                                                        <a href="<?php echo base_url('assets\extra-pages\email-templates\email-welcome.htm');?>" data-i18n="nav.email.email-template.welcome-email">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?php echo base_url('assets\extra-pages\email-templates\email-password.htm');?>" data-i18n="nav.email.email-template.reset-password">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?php echo base_url('assets\extra-pages\email-templates\email-newsletter.htm');?>" data-i18n="nav.email.email-template.newsletter-email">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?php echo base_url('assets\extra-pages\email-templates\email-launch.htm');?>" data-i18n="nav.email.email-template.app-launch">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="<?php echo base_url('assets\extra-pages\email-templates\email-activation.htm');?>" data-i18n="nav.email.email-template.activation-code">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="card-header">
                                                    <h5>Berikut Poli Pelayanan yang melakukan telemedicine</h5>
                                                </div>
                                                        ...
                                                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>9112</td>
                                                                    <td>Poli Paru</td>
                                                                    <td>dr. Nugroho, Sp.P</td>
                                                                    <td><button class="btn btn-success"><i class="icofont icofont-check-circled"></i>Daftar</button></td>
																	<td>Telemedicine dimulai jam 10.00 -  selesai</td>
                                                                </tr>
                                                                <tr>
																<td>9112</td>
                                                                    <td>Poli Paru</td>
                                                                    <td>dr. Dyah T, Sp.P</td>
                                                                    <td><button class="btn btn-success"><i class="icofont icofont-check-circled"></i>Daftar</button></td>
																	<td>Telemedicine dimulai jam 8.00 -  selesai</td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
                                                            <tr>
